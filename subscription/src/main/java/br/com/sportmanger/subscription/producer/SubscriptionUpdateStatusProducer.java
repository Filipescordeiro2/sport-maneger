...
@Slf4j
public class SubscriptionUpdateStatusProducer {

    private final KafkaTemplate<String, String> kafkaTemplate;
    private final ObjectMapper objectMapper;

    private static final String TOPIC = "subscription-update-status";

    /**
     * Envia um evento de atualização de status de subscription para o Kafka
     */
    public void sendStatusUpdate(SubscriptionResponse response) {
        try {
